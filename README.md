...
* **Computation:** NumPy (Vectorized mathematical operations)

* **Visualization:** Matplotlib (3D projections, live interactive plotting)

* **Architecture:** Object-Oriented Programming (OOP), Modular Design

Developed as an advanced academic project focusing on heuristic algorithms and artificial intelligence.